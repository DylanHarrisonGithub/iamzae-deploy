...
exports.default = (request) => new Promise(res => {
    request.files[Object.keys(request.files)[0]].mv('public/avatars/' + Object.keys(request.files)[0], (err) => __awaiter(void 0, void 0, void 0, function* () {
        if (err) {
            res({ code: 200, json: { success: false, messages: ["SERVER - ROUTES - UPLOADAVATAR - Failed to upload file."].concat(err.toString()) } });
        }
        else {
            file_service_1.default.readDirectory(`public/avatars`).then(sr => {
                res({
                    code: 200,
                    json: {
                        success: sr.success,
